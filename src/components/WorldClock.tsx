...
const timezones: TimeZone[] = [
  { code: "UTC", name: "Universal Time", timezone: "UTC", flag: "🌐" },
  ...
  { code: "PST", name: "Pacific Time (US)", timezone: "America/Los_Angeles", flag: "🇺🇸" },
  { code: "CST", name: "Central Time (US)", timezone: "America/Chicago", flag: "🇺🇸" },
